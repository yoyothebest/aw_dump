...
/#
    if ( getdvar( "clientSideEffects" ) != "1" )
        maps\createfx\mp_instinct_fx::main();
#/

//  thread interior_gas_burst_fx();
//  thread hallway_fireball_fx();
//  thread pyramid_explosion_fx();
...
//interior_gas_burst_fx()
//{
//	common_scripts\_exploder::activate_clientside_exploder(125);//gas bursts and sparks inside cave when dynamic event starts
//}
//
//interior_gas_rising_fx()
//{
//	wait (20);
//	common_scripts\_exploder::activate_clientside_exploder(135);//gas rising up from the large pit in the cave shortly before the fireballs in the cave and explosion
//}
//
//exterior_gas_burst_fx()
//{
//	common_scripts\_exploder::activate_clientside_exploder(100);//the quick gas bursts that come out of the ground and hoses throughout the level
//}
//
//
//hallway_fireball_fx()
//{
//	StopClientExploder(125);
//	StopClientExploder(135, undefined, true);
//	common_scripts\_exploder::activate_clientside_exploder(140);//gas explosion in cave
//	wait (14);
//	//common_scripts\_exploder::activate_clientside_exploder(150);//hallway fireballs
//	common_scripts\_exploder::activate_clientside_exploder(115);//small spot fires on ground and electrical sparks in hallways
//	wait (5);
//	StopClientExploder(150);
//}

//pyramid_explosion_fx()
//{
//	common_scripts\_exploder::activate_clientside_exploder(155);//pyramid explosion vfx
//	wait 0.6;
//	common_scripts\_exploder::activate_clientside_exploder(156);//pyramid post dynamic event vfx
//	common_scripts\_exploder::activate_clientside_exploder(110);//fire bursts from gas leaks and small generator damage explosions
//	common_scripts\_exploder::activate_clientside_exploder(120);//looping ambient gas fires
//	common_scripts\_exploder::activate_clientside_exploder(145);//thick falling dust to hide falling rock sim in cave
//	common_scripts\_exploder::activate_clientside_exploder(146);//thick falling dust to hide ramp in tunnel
//	wait (2);
//	StopClientExploder(100);
//	//common_scripts\_exploder::activate_clientside_exploder(160);//large lingering smoke column
//	wait (4);
//	StopClientExploder(146);
//	wait (11);
//	StopClientExploder(145);
//	
//}
...
{
	wait (1);
	common_scripts\_exploder::activate_clientside_exploder(105);//falling dust and rocks
}

//cave_rock_bouncing_fx()
//{
//	wait (.1);
//	common_scripts\_exploder::activate_clientside_exploder(130);//rocks on the ground that bounce up
//}

cave_drill_fx()
{	
	wait (2.5);
	common_scripts\_exploder::activate_clientside_exploder(201);//cave drill vfx
	common_scripts\_exploder::activate_clientside_exploder(202);//cave drill vfx
	common_scripts\_exploder::activate_clientside_exploder(203);//cave drill vfx
	common_scripts\_exploder::activate_clientside_exploder(204);//cave drill vfx
}

cave_drill_pounding_fx()
{	
	//wait (1);
	common_scripts\_exploder::activate_clientside_exploder(172);//cave drill vfx
}

drill_damage_fx()
{	
	wait (2);
	common_scripts\_exploder::activate_clientside_exploder(171);//drill damaged vfx
}
cave_drill_rock_impact_fx()
{	
	wait (0.4);
	common_scripts\_exploder::activate_clientside_exploder(172);//cave drill rock impact fx
}

//pigeon_fx()
//{	
//	wait (1);
//	common_scripts\_exploder::activate_clientside_exploder(173);//pigeons
//}
