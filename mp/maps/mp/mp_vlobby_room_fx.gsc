...
/#
    if ( getdvar( "clientSideEffects" ) != "1" )
        maps\createfx\mp_vlobby_room_fx::main();
#/
...
////	noself_delayCall( 1, ::playfxontag, getfx( "mp_ref_elev_water_trail" ), level.space_elevator_fx, "tag_origin" );
//	
...
attach_fx_to_mechanism() //attached the light mesh vfx to the mechanism
{
	wait 1;
...
part_b_mechanism_light_glow_fx() //turns on the lights as the mechanism is being locked into position
{
	wait 1;
	Lock_part_b = getent("elevator_lock_b", "targetname");
...
//vfx_light_shadow()
//{
//			vfxlgt = GetEnt("vfx_light", "targetname");
//			fx_id = getfx("vlobby_spt_shadow");
//			shadowFXlight = spawnfx(fx_id, vfxlgt.origin);
//			triggerFX(shadowFXlight);
//}
