...
/#
    if ( getdvar( "clientSideEffects" ) != "1" )
        maps\createfx\mp_highrise2_fx::main();
#/
...
{
	wait(2);
	helipad_light_glows = getstructarray( "helipad_fx_loc", "targetname" );
	
	foreach (helipad_fx in helipad_light_glows)
		{
			PlayFX (getfx ("light_clr_shell_filament_blue"), helipad_fx.origin);
		}
}
